    ...
    <header className="bg-gradient-to-r from-black via-[var(--color-gray-dark)] to-black text-white fixed w-full top-0 z-50 shadow-2xl border-b border-[var(--color-gold)] border-opacity-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 py-4">
          {/* Logo */}
          <Link href="/" className="shrink-0 hover:opacity-90 transition-all duration-300">
            <Image
              src="/images/logo.png"
          ...
          <nav className="hidden lg:flex items-center gap-6 ml-auto shrink-0">
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden ml-auto text-white hover:text-[var(--color-gold)] transition-colors duration-300"
